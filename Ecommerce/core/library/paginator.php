...
class Paginator 
{
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if($lastpage > 1)
		{
			...
			if ($this->_page > 1)
				$pagination.= "<a href='".$path."$this->_instance=$prev"."$ext'> Sebelumnya</a>";
			else
				$pagination.= "<span class='disabled'> Awal</span>";
			...
			if ($this->_page < $counter - 1)
				$pagination.= "<a href='".$path."$this->_instance=$next"."$ext'>Berikutnya </a>";
			else
				$pagination.= "<span class='disabled'>Akhir</span>";
			$pagination.= "</div>\n";
		}
