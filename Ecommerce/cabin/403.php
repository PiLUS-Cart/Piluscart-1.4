...
require_once( "../core/plcore.php" );

if (!$admins -> isLoggedIn()) { header('Location: ../cabin/login.php'); }

?>
<html>

<title>403 - PiLUS CMS</title>
	...
	<div class="errorWrapper">
		...
		<div class="errorContent">
			...
			<span class="errorDesc">Oops! Sorry, an error has occured. Forbidden!<br />&copy;
				2014 <span class="purple"> PiLus CMS</span>
			</span>

		</div>

	</div>
	<script type="text/javascript">function leave() {  window.location = "<?php echoPL_CABIN; ?>index.php?module=dashboard";} setTimeout("leave()", 3640);</script>
</body>
