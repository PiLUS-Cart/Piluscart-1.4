		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					ID :
					<?php if (isset($views['admin_id'])) echo $views['admin_id']; ?>
				</div>
						...
						<div class="col-lg-6">
							...
							<form method="post"
								...
								<input type="hidden" name="admeta_id"
									value="<?php if (isset($views['admeta_id'])) echo (int)$views['admeta_id']; ?>" />
								...
								<div class="form-group">
									...
									<img src="<?php echo $avatar; ?>"> <br> <label>*Upload Foto
										Baru</label> <input type="file" name="image" maxlength="200">
									<p class="help-block">*Tipe Foto harus JPG/JPEG</p>
								...
								<div class="form-group">
									<label>*Tanggal Lahir</label> <a href="javascript:"
										...
										src="../cabin/kalender/ico_calendar.gif"> </a> <input
										type="text" class="form-control" name="tanggal" id="tgl"
										value="<?php if (isset($views['userMeta']))  echo htmlspecialchars(tgl_eng_to_ind($views['userMeta'] -> getAdmeta_Borndate())); ?> ">
								...
								<div class="form-group">
									...
									<div class="checkbox">
										...
										<?php if (isset($views['gender']) && $views['gender'] == 'L') echo 'checked="checked"'; ?>>Laki-Laki
										</label>
									</div>
									<div class="checkbox">
										<label> <input name="gender" type="checkbox" value="P"
										<?php if (isset($views['gender']) && $views['gender'] == 'P') echo 'checked="checked"'; ?>>Perempuan
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									<label>*No.Telepon/Hp</label> <input type="text" name="phone"
										class="form-control"
										value="<?php if (isset($views['userMeta'])) echo htmlspecialchars($views['userMeta'] -> getAdmeta_Phone()); ?>">
								</div>
								...
								<div class="form-group">
									<label>Alamat</label> <input type="text" name="address"
										...
										value="<?php if (isset($views['userMeta'])) echo htmlspecialchars($views['userMeta'] -> getAdmeta_Address()); ?>">
								</div>
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" id="pilus" name="bio" maxlength="1000" required>
										<?php if (isset($views['userMeta'])) echo $views['userMeta'] -> getAdmeta_Bio(); ?>
									</textarea>
								</div>
